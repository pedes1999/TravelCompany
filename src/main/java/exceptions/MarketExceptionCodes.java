...
public class MarketExceptionCodes {
    ...
    public final static String CUSTOMER_INVALID_EMAIL = "The given email is not appropriate to create a customer";
    public final static String AIRPORT_CODE_NOT_FOUND = "The given airport code does not exist";
}
